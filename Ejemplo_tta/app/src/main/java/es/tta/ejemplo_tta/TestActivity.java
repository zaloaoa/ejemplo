...
public class TestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        data = (Data) intent.getSerializableExtra(MenuActivity.EXTRA_DATA);//data=data
        ...
        advise=test.getAdvice();//cogemos el consejo
        adviseType = test.getAdviseType();//cogemos el tipo
...
//consejo audio
    ...
    public void next(View view){
        ...
        intent.putExtra(MenuActivity.EXTRA_DATA,data);
        startActivity(intent);
    }
